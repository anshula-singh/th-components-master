...
const colors = {
  ...
  careersDark: "rgb(43, 71, 128)",
  careersLight: "rgb(247, 248, 251)",
  workDark: "rgb(43, 71, 128)",
  workLight: "rgb(251, 248, 242)",
...
function generateComponentStyleSheet(properties, css) {
  fs.outputFileSync(
    `./src/elements/tds/themeProvider/themeProvider.css`,
...
function generateStyleSheet(properties, css) {
  fs.outputFileSync(
    `./.dist/css/tds-theme-provider.css`,
