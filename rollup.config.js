...
export default [
  {
    ...
    manualChunks: {
      accessibility: ["@a11y/focus-trap", "./src/shared/menu.ts"],
      tds: glob.sync("./src/modules/tds-*"),
      tm: glob.sync("./src/modules/tm-*"),
      vendor: ["immer", "lwc"]
    },
    plugins
  },
...
function env() {
  return {
    ...
    "process.env.CROSS_ORIGIN_ASSETS": JSON.stringify(
